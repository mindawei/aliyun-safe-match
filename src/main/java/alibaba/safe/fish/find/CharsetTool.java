...
public class CharsetTool {
	...
	public static String getChineseInUrl(String inputUrl){
			...
			for(String part : parts){
				if(part.startsWith("xn--")){
					part = part.substring(4);
					 String strChinese = CharsetTool.decode(part);
					 return strChinese;
				}
			}
		} catch (Exception e) {
...
//		 String strChinese = CharsetTool.decode("1lq90ic1111111111117fzpc"); // xn--1lq90ic7fzpc
//		 System.out.println(strChinese);
//	}
	
//	public static void main(String[] args) throws Exception {
////	System.out.println(getChineseInUrl("http://xn--1lq90ic7fzpc.com"));
////	System.out.println(getChineseInUrl("http://www.xn--1-lp6axr.lnhzlaw.com/?product-115.html?...ka&mp_sourceid=0.1.1"));
////	System.out.println(getChineseInUrl("http://www.xn--jd-9j4d569afv8b.lovenancheng.com"));
//	System.out.println(getChineseInUrl("http://xn--111-w48dtz.coinforpay.com"));
//	
//	}
